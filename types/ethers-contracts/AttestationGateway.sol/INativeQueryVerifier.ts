...
export declare namespace INativeQueryVerifier {
  ...
  export interface INativeQueryVerifierInterface extends Interface {
    getFunction(nameOrSignature: "verifyAndEmit"): FunctionFragment;

    

    encodeFunctionData(functionFragment: 'verifyAndEmit', values: [BigNumberish, BigNumberish, BytesLike, INativeQueryVerifier.MerkleProofStruct, INativeQueryVerifier.ContinuityProofStruct]): string;
